...
function tickAdvance(prev) {
  ...
  function resolveObjective(type) {
    ...
    if (type === '바론') {
      ...
      objectives.baronAdvantage = { side, untilTick: tick + 6 };
    } else if (type === '드래곤') {
  ...
  if (isFinalTick) {
    ...
    // 즉시 끝내지 않고, 승리 팀이 패배 진영으로 서서히 진격해 그곳에서 계속 교전하다가,
  ...
  if (towerAvailable) {
    ...
    towerChance *= objectiveRushMult * opponentWeakBoost;
  }
