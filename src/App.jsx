...
// 배포판 전용: 타워/바론/드래곤 유형별 아이콘 이미지 (public/objective-icons/)
...
const JUNGLE_CAMPS = [
  { name: '블루 두꺼비', x: 16, y: 36, size: 10 },
  { name: '레드 돌거북', x: 42, y: 15, size: 10 },
  { name: '블루 블루', x: 24, y: 46, size: 10 },
  { name: '레드 늑대', x: 69, y: 40, size: 10 },
  { name: '레드 두꺼비', x: 80, y: 50, size: 10 },
  { name: '레드 블루', x: 70, y: 55, size: 10 },
  { name: '블루 레드', x: 50, y: 72, size: 10 },
  { name: '블루 돌거북', x: 55, y: 80, size: 10 },
  { name: '블루 늑대', x: 22, y: 53, size: 10 },
  { name: '레드 레드', x: 56, y: 20, size: 10 },
];
  ...
  function renderSim() {
    ...
    const headerNode = (
      <div className="mb-2">
        ...
        <div className="flex items-center justify-center gap-1 flex-wrap text-sm mt-2 px-2 py-1.5 rounded-lg" style={{ border: '1px solid #2A3550' }}>
          ...
          <span className="w-px h-4 mx-1" style={{ background: '#2A3550' }} />
