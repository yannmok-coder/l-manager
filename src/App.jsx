...
const CHAMPIONS = {
  TOP: ['가렌', '다리우스', '카밀', '레넥톤', '오른', '피오라', '나서스', '잭스', '세트', '아트록스', '쉔', '말파이트', '우디르', '볼리베어', '케넨', '신지드', '초가스', '트린다미어', '이렐리아', '럼블', '그웬', '크산테', '사이온', '퀸', '뽀삐', '우르곳'],
  ...
  ADC: ['징크스', '케이틀린', '이즈리얼', '카이사', '베인', '진', '애쉬', '루시안', '시비르', '자야', '트리스타나', '바루스', '미스 포츈', '드레이븐', '칼리스타', '아펠리오스', '사미라', '세나', '니코', '코그모', '트위치', '제리', '스몰더'],
