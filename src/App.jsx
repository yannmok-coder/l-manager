    ...
    const headerNode = (
      <div className="mb-2">
        ...
        <div className="flex items-center justify-center gap-1 flex-wrap text-sm mt-2 px-2 py-1.5 rounded-lg" style={{ border: '1px solid #2A3550' }}>
          ...
          <span className="inline-flex items-center gap-0.5">{LANES.reduce((sum, l) => sum + s.objectives.user.laneTowers[l], 0) + s.objectives.user.nexusTowers}🗼</span>
          <span className="w-px h-4 mx-1" style={{ background: '#2A3550' }} />
          <span className="inline-flex items-center gap-0.5">🗼{LANES.reduce((sum, l) => sum + s.objectives.ai.laneTowers[l], 0) + s.objectives.ai.nexusTowers}</span>
